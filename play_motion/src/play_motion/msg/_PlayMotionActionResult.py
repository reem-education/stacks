"""autogenerated by genpy from play_motion/PlayMotionActionResult.msg. Do not edit."""
import sys
...
class PlayMotionActionResult(genpy.Message):
  _md5sum = "b706bb16cb2e48dcf071f332fd367fc2"
  _type = "play_motion/PlayMotionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','play_motion/PlayMotionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = play_motion.msg.PlayMotionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = play_motion.msg.PlayMotionResult()

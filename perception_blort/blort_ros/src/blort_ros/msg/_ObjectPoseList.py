"""autogenerated by genpy from blort_ros/ObjectPoseList.msg. Do not edit."""
import sys
...
class ObjectPoseList(genpy.Message):
  ...
  _type = "blort_ros/ObjectPoseList"
...
"""
  ...
  _slot_types = ['std_msgs/Header','blort_ros/ObjectPose[]','time','time']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.properties = []
        for i in range(0, length):
          val2 = blort_ros.msg.NameTypeValue()
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          start = end

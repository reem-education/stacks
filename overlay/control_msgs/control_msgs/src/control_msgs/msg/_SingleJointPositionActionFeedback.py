"""autogenerated by genpy from control_msgs/SingleJointPositionActionFeedback.msg. Do not edit."""
import sys
...
class SingleJointPositionActionFeedback(genpy.Message):
  _md5sum = "3503b7cf8972f90d245850a5d8796cfa"
  _type = "control_msgs/SingleJointPositionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','control_msgs/SingleJointPositionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SingleJointPositionActionFeedback, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d.pack(_x.feedback.position, _x.feedback.velocity, _x.feedback.error))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.position, _x.feedback.velocity, _x.feedback.error,) = _struct_3d.unpack(str[start:end])
      return self

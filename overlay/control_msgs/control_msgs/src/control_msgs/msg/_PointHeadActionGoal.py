"""autogenerated by genpy from control_msgs/PointHeadActionGoal.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','control_msgs/PointHeadGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = control_msgs.msg.PointHeadGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = control_msgs.msg.PointHeadGoal()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.pointing_frame = str[start:end].decode('utf-8')
      else:

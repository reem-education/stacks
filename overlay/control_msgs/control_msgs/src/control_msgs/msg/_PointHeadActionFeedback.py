"""autogenerated by genpy from control_msgs/PointHeadActionFeedback.msg. Do not edit."""
import sys
...
class PointHeadActionFeedback(genpy.Message):
  _md5sum = "33c9244957176bbba97dd641119e8460"
  _type = "control_msgs/PointHeadActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','control_msgs/PointHeadFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PointHeadActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = control_msgs.msg.PointHeadFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = control_msgs.msg.PointHeadFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_d.pack(self.feedback.pointing_angle_error))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.pointing_angle_error,) = _struct_d.unpack(str[start:end])
      return self
